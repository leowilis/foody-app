...
import { useSignInForm } from '@/features/auth/components/hooks/useAuthForms'
...
export default function SignInForm() {
  ...
  return (
    <motion.form key="signin" onSubmit={onSubmit} className="flex flex-col gap-4 md:gap-5" {...fadeSlide}>
